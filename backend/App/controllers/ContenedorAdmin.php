...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="/Usuarios/">
        ...
        <li class="nav-item">
          ...
          <div class="" id="pagesExamples">
            <ul class="nav ms-4 ps-3">
              <li class="">
              <a href="/Usuarios">
                <span class="nav-link btn-primary" style="color: white; border-radius: 10px;" >
              ...
              <li class="">
                <a class="nav-link" id="change" href="/AdminConstancia">
                  <span class="sidenav-mini-icon"> C </span>
                  <span class="sidenav-normal"> Constancy </span>
                </a>
              </li>
         ...
         <li class="nav-item">
           <div class="" id="pagesExamples">
             <ul class="nav ms-4 ps-3">
               ...
               <li class="">
                 <a id="change" class="nav-link" href="/Usuarios">
                   <span class="sidenav-mini-icon"> U </span>
                   <span class="sidenav-normal">Users</span>
                 </a>
               </li>
