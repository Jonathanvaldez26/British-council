                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row">
                      ...
                      <label class="form-label">Conference Name *</label>
                            <div class="input-group">
                                <input id="nombre_conferencia" name="nombre_conferencia" class="form-control" maxlength="44" type="text" placeholder="Academic Record" value="" required="required" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                      </div>
                    </div>
                    <br>
