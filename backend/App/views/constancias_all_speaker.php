...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-3 col-md-12 mb-4">
        ...
        <br>
            <a href="/AdminConstanciaSpeaker/Add" type="button" class="btn btn-primary btn-sm"><span class="fa fa-plus"></span> Add</a>
        <br>
                ...
                <div class="table-responsive">
                    <table id="constanciasAll" class="table table-striped table-bordered align-items-center mb-0">
                        ...
                        <tr>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Name Conference</th>
